...
namespace BankWorm.View
{
    public class UserView
    {
        ...
        public Data.Customer CustomerReport(EFCustomerService efCustomerService)
        {
            Console.WriteLine("Enter customer ID");
            var reportCustNumber = Convert.ToInt32(Console.ReadLine());
            var reportCustomer = efCustomerService.GetCustomerById(reportCustNumber);
            return reportCustomer;
        }

        public Data.Customer CustomerAccess(EFCustomerService efCustomerService)
        {
            Console.WriteLine("Enter customer number");
            var customerNumber = Convert.ToInt32(Console.ReadLine());
            var customer = efCustomerService.GetCustomerById(customerNumber);
